...
function scene:create( event )
    ...
    -- initial starting text displayed
    local beginText = display.newText("Good Luck",screenW/2,screenH/4,native.systemFont,32)
    transition.to(beginText, {time=3000,x=beginText.x,y=-100, delay=1000, onComplete=function(thistext) thistext:removeSelf() end})
